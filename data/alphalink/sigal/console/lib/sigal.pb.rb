...
### <proto file: core/src/main/protobuf/sigal.proto>
...
module Com
  module Initsys
    module Sigal
      module Protocol
        class ResponseStatus < ::Protobuf::Message
          defined_in __FILE__
          class ResponseStatusCode < ::Protobuf::Enum
            defined_in __FILE__
            OK = 1
            ERROR = 2
            NOT_FOUND = 3
        ...
        class RecordMetadata < ::Protobuf::Message
          defined_in __FILE__
          optional :uint64, :creation_date, 1
          optional :uint64, :last_update_date, 2
        end
        class Codec < ::Protobuf::Enum
          defined_in __FILE__
          G711A = 0
          G711U = 1
          G729 = 2
        end
        class LidbQueryRequest < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :string, :number, 2
          optional :string, :account_code, 3
        ...
        class LidbQueryResponse < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :ResponseStatus, :status, 2
          optional :string, :number, 3
        ...
        class LidbUpdateRequest < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :string, :number, 2
          optional :string, :account_code, 3
        ...
        class LidbUpdateResponse < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :ResponseStatus, :status, 2
        end
        class ExdbQueryRequest < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :string, :account_code, 2
          extensions 1000..9999
        end
        class ExdbQueryResponse < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :ResponseStatus, :status, 2
          optional :string, :account_code, 3
        ...
        class ExdbUpdateRequest < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :string, :account_code, 2
          optional :uint32, :max_calls, 3
        ...
        class ExdbUpdateResponse < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :ResponseStatus, :status, 2
        end
        class EmdbQueryRequest < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :string, :number, 2
          optional :string, :insee_code, 3
        ...
        class EmdbQueryResponse < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :ResponseStatus, :status, 2
          optional :string, :number, 3
        ...
        class EmdbUpdateRequest < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :string, :insee_code, 2
          repeated :EmdbEntry, :entries, 3
        ...
        class EmdbTime < ::Protobuf::Message
          defined_in __FILE__
          optional :uint32, :hour, 1
          optional :uint32, :minute, 2
          optional :uint32, :second, 3
        end
        class EmdbEntry < ::Protobuf::Message
          defined_in __FILE__
          optional :string, :number, 1
          optional :uint32, :idx, 2
          optional :EmdbDay, :day, 3
        ...
        class EmdbUpdateResponse < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :ResponseStatus, :status, 2
          extensions 1000..9999
        end
        class EmdbListRequest < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :string, :insee_code, 2
          repeated :EmdbEntry, :entries, 3
        ...
        class EmdbListResponse < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :ResponseStatus, :status, 2
          optional :string, :insee_code, 3
        ...
        class NpdbQueryRequest < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :string, :number, 2
          extensions 1000..9999
        end
        class NpdbQueryResponse < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :ResponseStatus, :status, 2
          optional :string, :number, 3
        ...
        class Cdr < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :bool, :complete, 2
          optional :string, :node, 3
          optional :string, :icid, 4
          optional :CallAddress, :calling, 5
          optional :CallAddress, :called, 6
          optional :uint64, :begin_date, 7
          optional :uint32, :duration, 8
          optional :uint32, :billable_duration, 9
          optional :bool, :answered, 10
          optional :string, :end_cause, 11
        ...
        class CallAddress < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :string, :carrier_code, 2
          optional :string, :account_code, 3
        ...
        class Screening < ::Protobuf::Enum
          defined_in __FILE__
          RESERVED = 1
          USER_PROVIDED_SCREENED = 2
          NETWORK_PROVIDED = 3
        end
        class AddressPresentation < ::Protobuf::Enum
          defined_in __FILE__
          ALLOWED = 1
          RESTRICTED = 2
        end
        class SigalEventCategory < ::Protobuf::Enum
          defined_in __FILE__
          CALL = 1
        end
        class SigalEventCriticity < ::Protobuf::Enum
          defined_in __FILE__
          TRACE = 1
          DEBUG = 2
          INFO = 3
        ...
        class SigalEvent < ::Protobuf::Message
          defined_in __FILE__
          required :uint32, :version, 1
          optional :SigalEventCriticity, :criticity, 2
          optional :SigalEventCategory, :category, 3
