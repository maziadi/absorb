...
DELETE FROM version WHERE table_name ='test_adr';
INSERT INTO version VALUES ('test_adr', (SELECT table_version FROM version WHERE table_name='address')) ;
